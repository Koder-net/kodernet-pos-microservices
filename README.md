...
```mermaid
graph TD
    subgraph PresentationTier["Presentation Tier (Clients)"]
    ...
    subgraph CoreServices["Core Microservices Tier (Node.js / Go)"]
    ...
    subgraph PersistenceTier["Persistence Tier (Polyglot Data Stores)"]
    ...
    RateLimit --> InventorySvc
    RateLimit --> SalesSvc
    RateLimit --> CustomerSvc
    RateLimit --> PurchasingSvc
    RateLimit --> RepairSvc
    RateLimit --> AssemblySvc
    RateLimit --> LogisticsSvc
...
gantt
    ...
    API Gateway and Auth Service        :p1, 2026-09-01, 30d
    Postgres and MongoDB Infrastructure :p1_2, 2026-09-15, 20d
    section Phase 2 Catalog and Customers
    Catalog and Product Service         :p2, 2026-10-01, 30d
    Customer and Loyalty Service        :p2_2, 2026-10-15, 25d
    section Phase 3 POS and Inventory
    Inventory and Stock Service         :p3, 2026-11-01, 35d
    Sales and Checkout Service          :p3_2, 2026-11-15, 40d
    section Phase 4 Operations
    Purchasing and Suppliers            :p4, 2027-01-01, 25d
    Serial and Warranty Service         :p4_2, 2027-01-15, 25d
    Repairs and PC Builder              :p4_3, 2027-02-01, 30d
    section Phase 5 Finance and HR
    Finance Accounts and Accounting     :p5, 2027-03-01, 35d
    HR Attendance and Payroll           :p5_2, 2027-03-15, 30d
    section Phase 6 Multi-Client Launch
    Web Portal and Mobile App Release   :p6, 2027-04-15, 45d
```
